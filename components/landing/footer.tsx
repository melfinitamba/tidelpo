...
export default function Footer() {
  return (
    <footer className="text-white bg-black px-4 py-5  mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        {/* <img src="https://www.floatui.com/logo.svg" className="w-32 sm:mx-auto" /> */}
        <p className="leading-relaxed mt-2 text-[15px]">
          Tidelpo adalah platform monitoring tiang listrik yang ditujukan
          sebagai penelitian tugas akhir
        </p>
      </div>
      <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
        {footerNavs.map((item, idx) => (
          <li key={idx} className=" hover:text-yellow-200">
